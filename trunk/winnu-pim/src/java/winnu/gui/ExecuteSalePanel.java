...
public class ExecuteSalePanel extends javax.swing.JPanel {
	...
	private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Date saleDate = (Date) cal.getTime();   	
        
        control.saleController.executeSale(txtPatientName.getText(),"Sale");
    ...
    private void btnOverrideSaleActionPerformed(java.awt.event.ActionEvent evt) {
		control.saleController.overrideSale(lstSelectedItems.getSelectedIndex());
		updateItemList();
    }

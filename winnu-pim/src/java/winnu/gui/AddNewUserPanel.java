...
public class AddNewUserPanel extends javax.swing.JPanel {
    ...
    private void btnDoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoneActionPerformed
        ...
        if (!txtPassword.getText().equals(txtConfirmPassword.getText())){
            ...
            //JOptionPane.showConfirmDialog(null, "Are you sure you want to add this user?", "Add New User", JOptionPane.OK_CANCEL_OPTION);
            
            //if(JOptionPane.showConfirmDialog(null, "Are you sure you want to add this user?", "Add New User", JOptionPane.OK_CANCEL_OPTION) == 0){

...
public class AddItemPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        buttonGroup2.add(btnCapsule);
        buttonGroup2.add(btnTablet);
        buttonGroup2.add(btnSyrup);
        buttonGroup2.add(btnOtherType);

        
        txtOtherType.setEnabled(false);   
        btnRegulated.setSelected(true);
        btnTablet.setSelected(true);
        ...
        btnCapsule.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCapsuleActionPerformed(evt);
            }
        });
        ...
        btnOtherType.setText("Others: Pls. Specify");
        btnOtherType.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnOtherTypeActionPerformed(evt);
            }
        });
    ...
    private void btnSyrupActionPerformed(java.awt.event.ActionEvent evt){
    ...
    private void btnTabletActionPerformed(java.awt.event.ActionEvent evt){
    	if(btnTablet.isSelected()){
    		txtOtherType.setEnabled(false);
    		txtOtherType.setText("");
    	}
    }
    
    private void btnCapsuleActionPerformed(java.awt.event.ActionEvent evt){
    	if(btnCapsule.isSelected()){
    		txtOtherType.setEnabled(false);
    		txtOtherType.setText("");
    	}
    }
    
    private void btnOtherTypeActionPerformed(java.awt.event.ActionEvent evt){
    	if(btnOtherType.isSelected()){
...
//    	btnSubmit.addKeyListener();
        ...
        type = btnTablet.isSelected() ? "tablet" : (btnSyrup.isSelected() ? "syrup" : (btnCapsule.isSelected() ? "capsule" : txtOtherType.getText()));
        ...
        JOptionPane.showMessageDialog(null, txtBrandName.getText() +  " has been successfully added.", "Add Item", 1);
        ...
        txtMinimumSupplyLimit.setText("");
        txtInitialQuantity.setText("");
        txtSellingPrice.setText("");
        txtAcquisitionCost.setText("");
        btnRegulated.setSelected(true);
        btnTablet.setSelected(true);
        eDate_Day.setSelectedIndex(0);
        eDate_Month.setSelectedIndex(0);
        eDate_Year.setSelectedIndex(0);
        txtOtherType.setEnabled(false);
        txtOtherType.setText("");
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSupplierAddressActionPerformed
    	 txtGenericName.setText("");
         txtBrandName.setText("");
         txtSupplierAddress.setText("");
         txtSupplierName.setText("");
    ...
    private javax.swing.JRadioButton btnOtherType;

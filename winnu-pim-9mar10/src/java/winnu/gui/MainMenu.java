...
public class MainMenu extends javax.swing.JPanel {
    ...
    public MainMenu() {
        ...
        btnAddItem.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt){
                btnAddItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/addItem_focus.png")));
                lblAddItem1.setVisible(true);
                lblAddItem2.setVisible(true);
            }
            public void mouseExited(java.awt.event.MouseEvent evt){
                btnAddItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/addItem.png")));
                lblAddItem1.setVisible(false);
                lblAddItem2.setVisible(false);
            }
        });
        btnAddSupply.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt){
                btnAddSupply.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/addSupply_focus.png")));
                lblAddSupplies1.setVisible(true);
                lblAddSupplies2.setVisible(true);
            }
            public void mouseExited(java.awt.event.MouseEvent evt){
                btnAddSupply.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/addSupply.png")));
                lblAddSupplies1.setVisible(false);
                lblAddSupplies2.setVisible(false);
            }
        });
        btnNewSale.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt){
                btnNewSale.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/saleButton_focus.png")));
                lblNewSale1.setVisible(true);
                lblNewSale2.setVisible(true);
            }
            public void mouseExited(java.awt.event.MouseEvent evt){
                btnNewSale.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/saleButton.png")));
                lblNewSale1.setVisible(false);
                lblNewSale2.setVisible(false);
            }
        });
        btnViewSummaryReports.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt){
                btnViewSummaryReports.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/summaryReports_focus.png")));
                lblSummaryReports1.setVisible(true);
                lblSummaryReports2.setVisible(true);
            }
            public void mouseExited(java.awt.event.MouseEvent evt){
                btnViewSummaryReports.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/summaryReports.png")));
                lblSummaryReports1.setVisible(false);
                lblSummaryReports2.setVisible(false);
            }
        });
        btnLogout.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt){
                btnLogout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/logout_focus.png")));
                lblLogout1.setVisible(true);
                lblLogout2.setVisible(true);
            }
            public void mouseExited(java.awt.event.MouseEvent evt){
                btnLogout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/logout.png")));
                lblLogout1.setVisible(false);
                lblLogout2.setVisible(false);
            }
        });
        btnExit.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt){
                btnExit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/exitButton_focus.png")));
                lblExit1.setVisible(true);
                lblExit2.setVisible(true);
            }
            public void mouseExited(java.awt.event.MouseEvent evt){
                btnExit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/exitButton.png")));
                lblExit1.setVisible(false);
                lblExit2.setVisible(false);
            }
        });
    ...
    private void initComponents() {
        ...
        btnAddItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/addItem.png"))); // NOI18N
        ...
        btnAddSupply.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/addSupply.png"))); // NOI18N
        ...
        btnNewSale.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/saleButton.png"))); // NOI18N
        ...
        btnViewSummaryReports.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/summaryReports.png"))); // NOI18N
        ...
        btnLogout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/logout.png"))); // NOI18N
        ...
        btnExit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winnu/gui/exitButton.png"))); // NOI18N

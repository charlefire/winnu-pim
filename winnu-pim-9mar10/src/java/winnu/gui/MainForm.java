...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        addSupplyPanel = new winnu.gui.AddSupplyPanel();
        editOwnAccountPanel = new winnu.gui.EditOwnAccountPanel();
        addSupplyPanel1 = new winnu.gui.AddSupplyPanel();
        summaryReportsPanel = new winnu.gui.SummaryReportsPanel();
        mainMenu = new winnu.gui.MainMenu();
        ...
        replaceItemPanel.setBounds(30, 30, 700, 600);
        ...
        addSupplyPanel1.setBounds(30, 30, 420, 390);
        layeredPane.add(addSupplyPanel1, javax.swing.JLayeredPane.DEFAULT_LAYER);
    ...
    private void menuitemViewReportsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuitemSaleActionPerformed
        clearLayeredPane();
    ...
    private winnu.gui.AddSupplyPanel addSupplyPanel1;

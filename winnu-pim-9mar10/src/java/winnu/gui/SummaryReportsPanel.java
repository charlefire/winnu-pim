...
public class SummaryReportsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        //ung details palitan dito -------v
        //for(int i=0; i< control.reportController.retrieveFromItem().size(); i++){
        Object[] model = new Object[]{"Item No." , "Item", "Generic Name", "Supplier", "Quantity", "Unit", "Unit Cost", "Value"};
        //}     
        Object[][] modelObject = new Object[model.length][];
        modelObject[0]= model;
